...
export const createCampaignSchema = z
  .object({
    ...
    targetAmount: z
      .number()
      .positive()
      .min(1_000_000, "Target minimal Rp 1.000.000")
      .max(1_000_000_000, "Target maksimal Rp 1.000.000.000"),
    deadline: z.coerce
      .date()
      .refine(
        (d) =>
          d > new Date(Date.now() + MIN_DEADLINE_DAYS * 24 * 60 * 60 * 1000),
...
export const updateCampaignSchema = z
  .object({
    ...
    deadline: z.coerce
      .date()
      .refine((d) => d > new Date(), "Deadline harus di masa depan")
      .optional(),
...
export const addCampaignUpdateSchema = z.object({
  content: z
    .string()
    .min(20, "Update minimal 20 karakter")
    .max(2000, "Update maksimal 2000 karakter"),
});
...
export const getSavedCampaignsQuerySchema = z.object({
